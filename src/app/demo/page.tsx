...
export default function DemoPage() {
  return (
    <div className="h-screen w-screen flex flex-col gap-8 items-center justify-center relative">
      ...
      <p className="text-lg md:text-xl font-light text-center text-white mix-blend-exclusion max-w-2xl leading-relaxed pointer-events-none z-10 px-4">
